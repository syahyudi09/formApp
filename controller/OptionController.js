...
class OptionController{
    ...
    try {
        ...
        const question = await FormModel.findOneAndUpdate({
            _id: req.params.id,
            userId: req.jwt.id
        }, {
            $push: {
    ...
    async destroy(req, res) {
        try {
            ...
            const question = await FormModel.findOneAndUpdate({ _id: req.params.id, userId: req.jwt.id,  }, 
                                                        { 
                                                            $pull: { 
